...
pub extern "C" fn filesystem_open_volume(
...
pub extern "C" fn close(proto: *mut FileProtocol) -> Status {
...
pub extern "C" fn delete(_: *mut FileProtocol) -> Status {
    Status::UNSUPPORTED
}

pub extern "C" fn read(file: *mut FileProtocol, size: *mut usize, buf: *mut c_void) -> Status {
    use crate::fat::Read;
...
pub extern "C" fn write(_: *mut FileProtocol, _: *mut usize, _: *mut c_void) -> Status {
    Status::UNSUPPORTED
}

pub extern "C" fn get_position(_: *mut FileProtocol, _: *mut u64) -> Status {
    Status::UNSUPPORTED
}

pub extern "C" fn set_position(file: *mut FileProtocol, position: u64) -> Status {
...
pub extern "C" fn flush(_: *mut FileProtocol) -> Status {
    Status::UNSUPPORTED
}
