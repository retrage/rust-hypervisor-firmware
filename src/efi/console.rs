...
eficall! {
pub fn stdin_reset(_: *mut SimpleTextInputProtocol, _: Boolean) -> Status {
    Status::UNSUPPORTED
}
}

eficall! {
pub fn stdin_read_key_stroke(
...
eficall! {
pub fn stdout_reset(_: *mut SimpleTextOutputProtocol, _: Boolean) -> Status {
    Status::SUCCESS
}
}

eficall! {
pub fn stdout_output_string(
...
eficall! {
pub fn stdout_set_mode(_: *mut SimpleTextOutputProtocol, mode: usize) -> Status {
    if mode == 0 {
        Status::SUCCESS
    } else {
        Status::UNSUPPORTED
...
eficall! {
pub fn stdout_set_attribute(_: *mut SimpleTextOutputProtocol, _: usize) -> Status {
...
eficall! {
pub fn stdout_clear_screen(_: *mut SimpleTextOutputProtocol) -> Status {
    Status::UNSUPPORTED
}
}

eficall! {
pub fn stdout_set_cursor_position(
    _: *mut SimpleTextOutputProtocol,
    _: usize,
    _: usize,
) -> Status {
...
eficall! {
pub fn stdout_enable_cursor(_: *mut SimpleTextOutputProtocol, _: Boolean) -> Status {
    Status::UNSUPPORTED
}
}
