...
pub extern "C" fn stdin_reset(_: *mut SimpleTextInputProtocol, _: Boolean) -> Status {
    Status::UNSUPPORTED
}

pub extern "C" fn stdin_read_key_stroke(
...
pub extern "C" fn stdout_reset(_: *mut SimpleTextOutputProtocol, _: Boolean) -> Status {
    Status::SUCCESS
}

pub extern "C" fn stdout_output_string(
...
pub extern "C" fn stdout_test_string(
    _: *mut SimpleTextOutputProtocol,
    _: *mut Char16,
) -> Status {
    Status::SUCCESS
...
pub extern "C" fn stdout_query_mode(
    _: *mut SimpleTextOutputProtocol,
    mode: usize,
    columns: *mut usize,
    rows: *mut usize,
...
pub extern "C" fn stdout_set_mode(_: *mut SimpleTextOutputProtocol, mode: usize) -> Status {
    if mode == 0 {
        Status::SUCCESS
    } else {
        Status::UNSUPPORTED
...
pub extern "C" fn stdout_set_attribute(_: *mut SimpleTextOutputProtocol, _: usize) -> Status {
    // Accept all attribute changes but ignore them
    Status::SUCCESS
}

pub extern "C" fn stdout_clear_screen(_: *mut SimpleTextOutputProtocol) -> Status {
    Status::UNSUPPORTED
}

pub extern "C" fn stdout_set_cursor_position(
    _: *mut SimpleTextOutputProtocol,
    _: usize,
    _: usize,
) -> Status {
...
pub extern "C" fn stdout_enable_cursor(_: *mut SimpleTextOutputProtocol, _: Boolean) -> Status {
    Status::UNSUPPORTED
}
